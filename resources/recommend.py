...
class MovieRecommendResource(Resource):
    ...
    def get(self):
        ...
        # 1. 영화별 상관계수를 뽑아야한다.
        # 1-1 DB에서 movie테이블과 review테이블의 데이터를 가져와서 데이터프레임으로 만든다.
        try:
            ...
            # 1-2 데이터프레임의 모양을 상관계수 계산할수있도록 pivot_table해야한다
        ...
        # 3 가중치로 계산하여 응답한다. 이미 본 영화및 중복영화 제거한다.
        ...
        # 위의 코드는 판다스의 시리즈이므로  이를 json으로 바꿔 보내는 방법
